...
 Understand how to create a package in a Java project.
 Create a Java class with a main method and declare variables of different data types.
 Print variable values using System.out.println.
 Execute a Java program and view the output in the console.
